...
def efficient_front(stocks_dataframe, rf_rate, cml = None, return_goal = None, title = None):
    ...
    # Loading data
    #np.random.seed(1)
    #stock_data = pd.read_excel("C:/Users/WadeWilson1/sublime_games/0_invest_strategies/2_portfolio_management_app/CW/stock_data.xlsx")
...
def capital_investment_line(mean_returns, cov_matrix, stock_dataframe, returns_array, 
                            ...
                            expected_mean_returns, expected_stock_volatilities, return_goal = None):
...
In case you choose Yahoo finance, just specify the stocks tickers just like this : ***AV.L AZN.L BP.L BARC.L HSBA.L*** or ***MSFT AAPL JPM BA SHEL***. Press Enter.
...
# Choosing stocks (and corresponding dettings) to load ------------------------------------------------------------------------------------------------------------------------------------------------------------------
if ticker_symbols:
